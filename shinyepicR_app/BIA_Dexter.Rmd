...
```{r global settings, echo=FALSE}
  ...
  settings$n_base_agents <- 18162236 # 2015 estimate tuned to produce 2022 cohort size matching Stats Canada population estimates ### population parameter - could change to 10000 https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1710000501
