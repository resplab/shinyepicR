...
```{r Global Settings, echo=FALSE}
  ...
  p_case_detection <- c(0.05,0.07,0.09,0.11,0.13) # uptake parameter ###variable
...
saveRDS(all_overall_uptake, file = "all_overall_10000_005_013.RDa")
saveRDS(all_results_uptake, file = "all_results_10000_005_013.RDa")
saveRDS(bia_all_long_uptake, file = "bia_all_long_10000_005_013.RDa")
```
...
treat_unit_cost <- c(s1a_test_res$SABA, s1a_test_res$LAMA, s1a_test_res$LAMA_LABA, s1a_test_res$ICS_LAMA_LABA, s1a_test_res$NRT)
treat_cost_yr <- rowSums(t(c(treat_unit_cost)*t(treat)))

# hospitalisation
hosps <- cbind(s1a_test_res$exacs_sev, s1a_test_res$exacs_vsev)
hosps_unit_cost <- c(s1a_test_res$exac_sev, s1a_test_res$exac_vsev)
hosps_cost_yr <- rowSums(t(c(hosps_unit_cost)*t(hosps)))

# background medical
copd <- cbind(s1a_test_res$copd_GOLD1, s1a_test_res$copd_GOLD2, s1a_test_res$copd_GOLD3, s1a_test_res$copd_GOLD4) # replace s1a_test_res with my own results 
